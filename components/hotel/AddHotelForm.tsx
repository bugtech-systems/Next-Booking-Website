    ...
    <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                ...
                <div className='flex justify-between gap-2 flex-wrap'>
                    {hotel && <Button variant="ghost" onClick={() => handleDeleteHotel(hotel)} type="button" className="max-w-[150px]" disabled={isHotelDeleting}>
                        {isHotelDeleting ? <><Loader2 className='mr-2 h-4 w-4'/>Deleting</> : <><Trash className='mr-2 h-4 w-4'/> Delete</>}
                    </Button>}
                    
                    {hotel && <Button variant="outline" type="button" onClick={() => router.push(`/hotel-details/${hotel.id}`)}><Eye className='mr-2 h-4 w-4' />View</Button>}
                    ...
                    <Button className='max-w-[150px]' disabled={isLoading}>{isLoading ? <><Loader2 className='mr-2 h-4 w-4'/> Creating</> :<><Pencil className='mr-2 h-4 w-4'/>Create Hotel</>}
                    </Button> }
                </div>
