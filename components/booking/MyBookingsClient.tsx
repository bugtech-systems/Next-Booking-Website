...
import { AirVent, Bath, Bed, BedDouble, Castle, Home, Loader2, MapPin, MountainSnow, Pencil, Plus, Ship, Trash, Trees, Tv, Users, UtensilsCrossed, VolumeX, Wand2, Wifi } from "lucide-react";
...
const MyBookingClient: React.FC<MyBookingClientProps> = ({booking, myBookings}) => {
    ...
    return ( 
        ...
        <CardHeader>
            ...
            <CardContent className="flex-grow flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="text-primary/90">
                        ...
                        {booking.breakFastIncluded && <div>Breakfas will be served</div>}
            ...
            <CardFooter className="flex items-center justify-between">
                ...
                {!booking.paymentStatus && booking.userId === userId && myBookings && <Button disabled={bookingIsLoading} className="text-teal-700" onClick={() => handleBookRoom()}>Pay Now</Button>}
            </CardFooter>
