...
export default function RoomPaymentForm({clientSecret, handleSetPaymentSuccess}: RoomPaymentProps) {
  ...
  return (
        <form onSubmit={handleSubmit}>
                ...
                {isLoading && <div>Payment Processing... Please stay on this page as we process your payment</div>}
                {isLoading && 
                ...
                <Button className="mt-5" disabled={isLoading}>{isLoading ? 'Processing Payment...' : 'Pay Now'}</Button>
        </form>
  )
}
